...
const QcImages = ({ navigation }) => {

    const imagesData = useSelector((state)=>state.basicCarDetail.QcData)     
    useEffect(() => {
        requestCameraPermission()

    }, [])

 console.log(imagesData.data.vehicleImages,"sdf raemsh")
    ...
    useEffect(() =>{
        const imgs=Object.keys(imagesData.data.vehicleImages).map((key)=>imagesData.data.vehicleImages[key])
                ...
                renderItem={({ item, index }) => {
                    return (
                        <VehicaleImageComponent
                            text={convertCase(Object.keys(imagesData.data.vehicleImages)[index])}
                            image={item.image}
                            index={index}
                            ...
                            //     imageKey:Object.keys(imagesData.data.vehicleImages)[index]
