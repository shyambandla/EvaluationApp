...
import { captureButton, } from '../constants/Images';
...
const MyCamera = (props) => {
    ...
    const onBottomButtonPressed = (event) => {
        ...
        ImgToBase64.getBase64String(image.uri)
            .then(base64String => props.setImageData(base64String))
            .catch(err => { });
        ...
        <SafeAreaView style={{ flex: 1 }}>
            ...
            <View style={{ flex: 1 }}>
                {isPermitted && <CameraScreen
                    ...
                    captureButtonImage={captureButton}


                    captureButtonImageStyle={{ width: 80, height: 80 }}
                />}
            </View>
